 ...
 * @returns {Promise<{db: {id:string; originalURL: string; shortURL: string}[]}>}
 */
 ...
 * @param {{db: {id:string; originalURL: string; shortURL: string}[]}} data
 */
...
module.exports = { createLink, addLink, readDB, writeDB, generateString };
